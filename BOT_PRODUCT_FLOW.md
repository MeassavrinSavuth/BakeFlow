...
Purpose
-------
replace the chatbot's hard-coded menus with dynamic product listings from the inventory (database). This describes which files to change, recommended function signatures, payload formats, and testing notes.
